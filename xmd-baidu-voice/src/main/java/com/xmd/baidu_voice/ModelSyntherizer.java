 ...
 */
public class ModelSyntherizer {
    protected SpeechSynthesizer mSpeechSynthesizer;
    protected Context context;
    protected android.os.Handler mainHandler;
    ...
    public ModelSyntherizer(Context context, InitConfig initConfig, android.os.Handler mainHandler) {
        this(context, mainHandler);
        init(initConfig);
    }

    protected ModelSyntherizer(Context context, android.os.Handler mainHandler) {
        if (isInitied) {
